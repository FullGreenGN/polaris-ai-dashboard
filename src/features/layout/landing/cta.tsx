...
export function CallToAction() {
    return (
        <div className="mb-20 mt-20 relative mx-auto flex w-full max-w-6xl flex-col justify-between gap-y-6 border-y bg-[radial-gradient(35%_80%_at_25%_0%,--theme(--color-foreground/.08),transparent)] px-4 py-8">
            <PlusIcon
            ...
            <div className="flex items-center justify-center gap-2">
                <Button variant="outline">Invite bot</Button>
                <Button>
